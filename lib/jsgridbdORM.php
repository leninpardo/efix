...
//                $filtro = json_decode($params['filters']);
                ...
                $reglas = $filtro->rules;
                $comienzo = '0';
                if (isset($params['comienzo'])){
                    $comienzo = $params['comienzo'];
                }
                
                foreach ($reglas as $value ) {
                    $this->AgregarCondicion($value->field,$value->data,$value->op,$and_or,$comienzo);
                }
    ...
    private function AgregarCondicion($campo,$dato,$operacion,$tipo,$comienzo){
        $wh = "";
