<?php
    ...
    function es_numero($var, $campo) {
        ...
        if (stristr($campo, 'num_documento') || stristr($campo, 'dni') || stristr($campo, 'ruc')|| stristr($campo, 'b_codigopatrimonio')|| stristr($campo, 'tb_id')|| stristr($campo, 'f_nrodoc')|| stristr($campo, 'num_carta_asignacion')|| stristr($campo, 'codigo')) {
            return false;
        } else {
