...
class jsGrid{
 ...
 protected $keybordactive = false;
    var $rowList = "10,20,30,100,200"; //lista de cuantas filas de deben mostrar
    ...
    var $mostrarPie = false;
    
    public function getMostrarPie() {
        return $this->mostrarPie;
    }

    public function setMostrarPie($mostrarPie) {
...
//search:true,align:"right",forceFit : true,autowidth: true,
    ...
    private function crearGrilla(){
        ...
        if ($this->mostrarPie === true){
            $cadena .="footerrow:true\n,";
            $cadena .="userDataOnFooter:true\n,";
            $cadena .="altRows:true\n,";
        }
...
PDFE;
        ...
        */
          if ($this->conBusqueda == true)
            $cadena .= "jQuery('#$this->tabla').jqGrid('filterToolbar',{stringResult: true,searchOnEnter : {$this->searchOnEnter}});";
        
            /*if ($this->keybordactive == true)
            $cadena .= "jQuery('#{$this->tabla}').jqGrid('bindKeys', {\"onEnter\":function( rowid,e ) {{$this->FnPostKey}(rowid);e.preventDefault();} } );";
        */
        $cadena .= "});";
    ...
    public function getKeyboardActive(){
        return $this->keybordactive;
    }
    public function setKeyboardActive($FnPostKey){
        $this->keybordactive=true;
        $this->FnPostKey=$FnPostKey;
    }
  public function setsearchOnEnter($value){
        $this->searchOnEnter=$value;
    }
}
