...
*/
	...
	*/
	...
	global $ADODB_FLUSH,$ADODB_OUTP;
		...
		$file = $GLOBALS["phpORM"]["filedebug"];

		if ( $file == null )
		{	// Muestra la depuracion en el navegador ... comportamiento estandar
			if ($newline) $msg .= "<br>\n";
		...
		}else{ //Envia la depuracion a un archivo especifico.
	...
	*/
	 ...
	 * @return  the last hted ID. Not all databases support this.
	 */ 
