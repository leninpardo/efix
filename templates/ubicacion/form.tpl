{include file=$links}
<script type="text/javascript" src="{$HOST}js/modulos/ubicacion.js"></script>
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            <select name="id_ambiente" id="id_ambiente" style="width: 100%" title="Seleccione Ambiente">
                                {foreach from=$ambiente item="ambi"}
                                    <option value="{$ambi->ambi_id}" >{$ambi->ambi_descripcion}</option>
                                {/foreach}
                            </select> 
                        </td>
                    </tr>  
