...
<link type="text/css" rel="stylesheet" media="screen" href="{$HOST}css/theme/jquery-ui-1.8.17.custom.css"/>
...
<script type="text/javascript" src="{$HOST}js/jquery.layout.js"></script>
